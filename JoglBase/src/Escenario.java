...
class Escenario extends GLJPanel implements GLEventListener, KeyListener {
    ...
    public void drawFigure(GL2 gl, GLUT glut) {
        gl.glTranslatef(1.5f, -1f, 1.0f);
        this.setSomeGreenMaterial(gl, GL.GL_FRONT);
        this.setOpaque(true);
        glut.glutSolidCube(2.0f);

        this.setSomeRedMaterial(gl, GL.GL_FRONT);
        gl.glTranslatef(-3.0f, -0.2f, 1.0f);
        glut.glutSolidOctahedron();
        
        this.setSomeDarkGrayMaterial(gl, GL.GL_FRONT);
        gl.glTranslatef(3.0f, -5.0f, -2.0f);
        glut.glutSolidCube(8.0f);
        
        this.setSomeBlueMaterial(gl, GL.GL_FRONT);
        gl.glTranslatef(-1.0f, 5.0f, -2.0f);
        glut.glutSolidCube(1.0f);
        
        this.setSomeYellowMaterial(gl, GL.GL_FRONT);
        gl.glTranslatef(4.0f, -0.3f, 3.0f);
